...
sleep 1
send_raw_message "lane 7 0:25,11 0"
send_raw_message "lane 1 0:25,12 0"
sleep 5
send_raw_message "lane 8 0:33,13 0"


sleep 10

# laps
send_raw_message "lane 4 0:58,71 0"
sleep 1
send_raw_message "lane 5 0:59,71 0"
send_raw_message "lane 3 0:59,88 0"
send_raw_message "lane 6 0:59,96 0"
sleep 1
send_raw_message "lane 2 1:01,21 0"
sleep 1
send_raw_message "lane 7 1:02,11 0"
send_raw_message "lane 1 1:02,12 0"
sleep 5
send_raw_message "lane 8 1:03,13 0"

sleep 17

# end
send_raw_message "lane 4 0:58,71 1"
sleep 1
...
sleep 1
send_raw_message "lane 7 1:02,11 6"
send_raw_message "lane 1 1:02,12 7"
sleep 1
send_raw_message "lane 8 1:03,13 8"
